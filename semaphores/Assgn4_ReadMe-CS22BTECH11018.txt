...
DESCRIPTION
    ...
    There are 2 cpp files and one report and one inp-paramas.txt
...
Input format :
-> Input is given through a text file "inp-paramas.txt".
-> It will consist of six parameters: nw  nr  kw  kr  muCS  muRem;

  

COMPLILING INSTRUCTIONS
    command to complile rw code - g++ rw-CS22BTECH11018.cpp 
    ...
    command to complile CAScode - g++ frw-CS22BTECH11018.cpp 
    command to execute compiled code - ./a.out
     two output files generated 
    1)FairRW-log.txt
